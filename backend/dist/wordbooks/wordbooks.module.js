...
const wordbooks_controller_1 = require("./wordbooks.controller");
...
exports.WordbooksModule = WordbooksModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [wordbooks_controller_1.WordbooksController],
        providers: [wordbooks_service_1.WordbooksService],
        exports: [wordbooks_service_1.WordbooksService],
    })
], WordbooksModule);
